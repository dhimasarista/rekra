...
<head>
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="../admin/vendor/TopLoaderService/TopLoaderService.css"
    />
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="../admin/src/plugins/TopLoaderService/TopLoaderService.css"
    />
    <script>
    ...
    * {
    ...
    .LoginPageInnerContainer .ImageContianer {
        width: 50%;
        background-image: url('https://images.unsplash.com/photo-1604451372323-158c45058d10?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
            ...
            <div class="LoginFormContainer">
                <div class="LoginFormInnerContainer">
                    <div class="LogoContainer">
                        ...
                        <h1><i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M5 19h14v1H5z" opacity="0.3"/><path fill="currentColor" d="M18 13h-.68l-2 2h1.91L19 17H5l1.78-2h2.05l-2-2H6l-3 3v4c0 1.1.89 2 1.99 2H19a2 2 0 0 0 2-2v-4zm1 7H5v-1h14z"/><path fill="currentColor" d="M12.048 12.905L8.505 9.362l4.95-4.95l3.543 3.543z" opacity="0.3"/><path fill="currentColor" d="M19.11 7.25L14.16 2.3a.975.975 0 0 0-1.4-.01L6.39 8.66a.996.996 0 0 0 0 1.41l4.95 4.95c.39.39 1.02.39 1.41 0l6.36-6.36a.996.996 0 0 0 0-1.41m-7.06 5.65L8.51 9.36l4.95-4.95L17 7.95z"/></svg>
                        </i>Rekra 2024</h1>
                        <br>
                    </div>
                    ...
                    <form>
                        ...
                        <div class="inputContainer">
                            ...
                            <input class="input" type="text" name="username" placeholder="Masukkan Nama Pengguna" required>
                        </div>
                        <div class="inputContainer">
                            ...
                            <input name="password" class="input" type="password" placeholder="Masukkan Kata Sandi" required>
                        </div>
                        <div style="color: red;">
