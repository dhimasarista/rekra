    ...
    <div class="menu-block customscroll">
      ...
      <div class="sidebar-menu">
        <ul id="accordion-menu">
          <li>
            <a href="/rekapitulasi" class="dropdown-toggle no-arrow @if (request()->url() === '/rekapitulasi')@endif">
              <span class="micon dw dw-columns1"></span><span class="mtext">Rekapitulasi</span>
            </a>
          </li>
          <li>
            <a href="/provinsi" class="dropdown-toggle no-arrow @if (request()->url() === '/provinsi')@endif">
            <span class="micon dw dw-down-arrow-7"></span>
              <span class="mtext">Input Provinsi</span>
            </a>
          </li>
          <li>
            <a href="/kabkota" class="dropdown-toggle no-arrow @if (request()->url() === '/kabkota')@endif">
          ...
          <li>
            <a href="/users" class="dropdown-toggle no-arrow @if (request()->url() === '/users')@endif">
