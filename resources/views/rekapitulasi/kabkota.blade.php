                        ...
                        <div class="row">
                                    ...
                                    <script>
                                        ...
                                        $("#select-nama-provinsi").on("change", e => {
                                            ...
                                            $.ajax({
                                                ...
                                                dataType: "json",
                                                url: `/rekapitulasi/wilayah/kabkota?Provinsi=${$("#select-nama-provinsi").val()}`,
                                                // data: "data",
                                                success: function(response) {
                                                    const namaWilayah = $("#select-nama-kabkota")
                                                    namaWilayah.empty();
                                                    namaWilayah.append('<option>Pilih</option>');
                                                    response["kabkota"].forEach(x => {
                                                        namaWilayah.append(
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled id="select-nama-kabkota" class="custom-select2 form-control"
